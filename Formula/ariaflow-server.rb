class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.254.tar.gz"
  sha256 "b17607b86014a5334a3e3d02476566458087a841ca4473e111ab228f6661fd5f"
  version "0.1.254"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
