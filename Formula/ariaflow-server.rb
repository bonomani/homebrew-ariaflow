class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.241.tar.gz"
  sha256 "be867bd96c9fc1adb9774a78bb0e96c72ade6c4b8bc216aeef71ec13333edb3c"
  version "0.1.241"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
