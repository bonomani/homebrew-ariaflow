class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.262.tar.gz"
  sha256 "568ab99928fcabf588f84e00221f313e2e6e950eaa807ae1be742a633102d65d"
  version "0.1.262"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
