class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.213.tar.gz"
  sha256 "d078bd25bba5b92d310d584cf862cc83ddf73b0fffc9e824ba75b9cfc198b61a"
  version "0.1.213"
  license "MIT"
  depends_on "python"
  depends_on "aria2"
