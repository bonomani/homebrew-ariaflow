class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.309.tar.gz"
  sha256 "e0368ca338d1eee3eec9d8fa098d6ab99816c0837b745d54fbba9dbfcbbf604e"
  version "0.1.309"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
