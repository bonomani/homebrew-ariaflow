class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.222.tar.gz"
  sha256 "e370ce00687ea9c910bed4d443fd62b82f86b3fd9891c6ee4a9f8c782921599d"
  version "0.1.222"
  license "MIT"
  depends_on "python"
  depends_on "aria2"
