class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.256.tar.gz"
  sha256 "c798528ad6c5359bcf8c4c4b3fd1295e982d5351fa9133a90ab101a41cf6b3ed"
  version "0.1.256"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
