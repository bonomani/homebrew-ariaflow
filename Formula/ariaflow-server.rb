class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.265.tar.gz"
  sha256 "b990f86e95f2781e25e3ecd71b87757657bda98907c0c9841d4e1672eab0316a"
  version "0.1.265"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
