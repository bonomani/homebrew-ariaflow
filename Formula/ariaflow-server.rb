class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.317.tar.gz"
  sha256 "285930cceae65a436b8d228062e1bdf22a00e7bdecc49641434773e8863780cc"
  version "0.1.317"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
