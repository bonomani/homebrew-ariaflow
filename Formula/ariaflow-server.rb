class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.219.tar.gz"
  sha256 "133ab5d6c7f3a1b05a62a20ef811899cda6422ff8953d347eb97c4d6558829db"
  version "0.1.219"
  license "MIT"
  depends_on "python"
  depends_on "aria2"
