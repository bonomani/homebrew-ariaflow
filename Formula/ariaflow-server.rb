class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.275.tar.gz"
  sha256 "bc2eea8437def912ab34988a915f7cda7be590d750b0fd0602644dacc42d81e0"
  version "0.1.275"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
