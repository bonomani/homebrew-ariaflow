class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.217.tar.gz"
  sha256 "74b25ae711671ae449300c34ccf2e130bda52ab5361a3826453cff3b2163e0b1"
  version "0.1.217"
  license "MIT"
  depends_on "python"
  depends_on "aria2"
