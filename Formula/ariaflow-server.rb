class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.226.tar.gz"
  sha256 "e1c9270ef962d250b6e77a3ab50eb5affeb3e2208b6df77af96ccf65f0cd0c2e"
  version "0.1.226"
  license "MIT"
  depends_on "python"
  depends_on "aria2"
