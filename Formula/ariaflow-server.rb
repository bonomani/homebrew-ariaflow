class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.246.tar.gz"
  sha256 "e6b01eadbf0f0222d6d607ddf505331441931e077d90941608790dab598ba93e"
  version "0.1.246"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
