class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.273.tar.gz"
  sha256 "16424d180478d77a72ada4ddfeaa9e367a14a6e4f5bd4dcaa0e71c4605626c5d"
  version "0.1.273"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
