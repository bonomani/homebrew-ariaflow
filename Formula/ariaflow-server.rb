class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.190.tar.gz"
  sha256 "9ee7c4334ff1e909bc1729c2ad5b78a5b5afc0cb07575144a11f989f34f4cdc5"
  version "0.1.190"
  license "MIT"
  depends_on "python"
  depends_on "aria2"
