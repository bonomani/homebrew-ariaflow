class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.271.tar.gz"
  sha256 "c2e7252f7428860ae2878aaec3cde3fc89af1aeb3406fcccd58ed32f8f466653"
  version "0.1.271"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
