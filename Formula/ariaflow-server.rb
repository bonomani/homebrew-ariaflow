class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.168.tar.gz"
  sha256 "bf5292afc4f07e1efed4ac21210c1843a082b26102b7a985a20b8300c8d2ea49"
  version "0.1.168"
  license "MIT"
  depends_on "python"
  depends_on "aria2"
