class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.298.tar.gz"
  sha256 "49d0d68242bf9b51d4ad9f8f5f1097f97275336aad38c0da143e8f7b78087cdb"
  version "0.1.298"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
