class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.212.tar.gz"
  sha256 "8e67468f8dbee44c95798a759c49a612e0559ae73ec5f5e020d5e1b63878b9c8"
  version "0.1.212"
  license "MIT"
  depends_on "python"
  depends_on "aria2"
