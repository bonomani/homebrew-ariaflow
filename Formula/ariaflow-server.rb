class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.286.tar.gz"
  sha256 "2ed67da3ae72fda55c962b23a469b05cf964f563969201ebee4c49b387d5ecdf"
  version "0.1.286"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
