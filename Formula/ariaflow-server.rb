class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.287.tar.gz"
  sha256 "a7d1638b953efaa8358971156e6a57b1af3b3ffc3f5a518a7fe169ce747854e4"
  version "0.1.287"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
