class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.294.tar.gz"
  sha256 "410e45b801ab5e447b45066fcfe6d99298bdec7212451c97a4f78960cf7cb09b"
  version "0.1.294"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
