class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.239.tar.gz"
  sha256 "f1f17d91301980583dc79493edf651686b0b34861ffac24d3913a28483387092"
  version "0.1.239"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
