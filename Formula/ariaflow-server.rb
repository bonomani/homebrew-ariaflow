class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.204.tar.gz"
  sha256 "6bfb82e1d31902d72a03f10fdf2210e87f194295f4d0bac533ce20bd358617fb"
  version "0.1.204"
  license "MIT"
  depends_on "python"
  depends_on "aria2"
