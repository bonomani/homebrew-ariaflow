class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.242.tar.gz"
  sha256 "afada09040ad43fc5a56a7caa7aa8ce95c9147a111328a0022660b439df7931d"
  version "0.1.242"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
