class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.308.tar.gz"
  sha256 "45a861d3a13999f34560f06cb91cf42830fd62f32885dc87b535b020cb0c1811"
  version "0.1.308"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
