class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.197.tar.gz"
  sha256 "ca7b9aafa0f869a5ad470448fc8e246fd49bb7c682b73008083a9c6eb558abc9"
  version "0.1.197"
  license "MIT"
  depends_on "python"
  depends_on "aria2"
