class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.220.tar.gz"
  sha256 "ca13617f6c34a6289647e90ad54898083e6692f126105fdb20d668d1489eed77"
  version "0.1.220"
  license "MIT"
  depends_on "python"
  depends_on "aria2"
