class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.311.tar.gz"
  sha256 "33dc7a38038f66644833d468b00e8b960b234a9ca6efa5f0f92eb3b2ba2e104c"
  version "0.1.311"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
