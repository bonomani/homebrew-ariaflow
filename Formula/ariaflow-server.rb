class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.250.tar.gz"
  sha256 "5d786f5d080288ef5abe443887256807943c7293cb977ab5db779a651e6655e4"
  version "0.1.250"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
