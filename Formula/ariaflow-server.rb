class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.267.tar.gz"
  sha256 "da48f3f2cd383aec6e120857a4b19d0cce1ca86ca6477430c408bd3555222990"
  version "0.1.267"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
