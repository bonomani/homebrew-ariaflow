class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.270.tar.gz"
  sha256 "c1882aa9a8a018ad5594659e9da983a1a87f5f3b6b23fcb5ea1c08d644ff8f9b"
  version "0.1.270"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
