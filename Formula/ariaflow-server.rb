class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.306.tar.gz"
  sha256 "09af0b99567f9f5eb433431dc88219c869b1a77f67863af5b74cd9bf58a446ed"
  version "0.1.306"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
