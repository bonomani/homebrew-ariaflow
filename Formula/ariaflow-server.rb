class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.305.tar.gz"
  sha256 "efb5dee46cfea6a6b359c78cd46578223e8beab77ec82259d526257c2d9a4ec9"
  version "0.1.305"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
