class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.245.tar.gz"
  sha256 "0220f7b672d11b80138fcfa5b0b70b9cc038d399419aa16ea430b0b4fe8ecb3c"
  version "0.1.245"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
