class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.303.tar.gz"
  sha256 "578f293b7da11495a0e1b1623231a1aed18ddc3a7cc91b8263bf6738d8826616"
  version "0.1.303"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
