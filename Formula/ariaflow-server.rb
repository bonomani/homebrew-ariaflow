class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.243.tar.gz"
  sha256 "7a3df9b855478cbcb857e48b51039f663e5ffe63d2a3296d34e7a8f421915177"
  version "0.1.243"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
