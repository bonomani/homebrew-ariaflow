class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.282.tar.gz"
  sha256 "eed5eb9514c8a9cb15cdb28f08b2dfbb4a89808768841334287da4fadc1e1e10"
  version "0.1.282"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
