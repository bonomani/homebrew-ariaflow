class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.169.tar.gz"
  sha256 "f647b49f559e115489a75671193693b06db6cd919371dfeedba69a421f3ae052"
  version "0.1.169"
  license "MIT"
  depends_on "python"
  depends_on "aria2"
