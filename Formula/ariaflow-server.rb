class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.200.tar.gz"
  sha256 "803c51d05165f554a11dfb441bb9c20810fd1f3a9b76bc51dc3b8cd2e1911bff"
  version "0.1.200"
  license "MIT"
  depends_on "python"
  depends_on "aria2"
