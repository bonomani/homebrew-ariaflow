class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.211.tar.gz"
  sha256 "849009ce528023257197e3ae0bb8e1020e867a0378963c06db63834ef286dc44"
  version "0.1.211"
  license "MIT"
  depends_on "python"
  depends_on "aria2"
