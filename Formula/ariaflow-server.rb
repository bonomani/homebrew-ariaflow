class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.307.tar.gz"
  sha256 "c1f15b474f63bbab446bbc2b887d63a1d7bfc086cc797e7938dc0d493103ad5e"
  version "0.1.307"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
