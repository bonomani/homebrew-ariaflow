class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.264.tar.gz"
  sha256 "4d5606c505c3f09333766396d284aede68a777866b0930a93f0f9edd79d4a996"
  version "0.1.264"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
