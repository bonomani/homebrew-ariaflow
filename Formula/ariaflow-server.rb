class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.221.tar.gz"
  sha256 "90c96bfbb465d61f852f19ff56803bc21c167813ab5df46b63898df005b1024f"
  version "0.1.221"
  license "MIT"
  depends_on "python"
  depends_on "aria2"
