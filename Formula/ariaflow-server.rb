class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.225.tar.gz"
  sha256 "22b41376f5035d77222d7370358d1804473e40d554734761878bb65374844eb4"
  version "0.1.225"
  license "MIT"
  depends_on "python"
  depends_on "aria2"
