class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.224.tar.gz"
  sha256 "ecc2c6bf4bfa84d7547a9acd339606059adaf2e861ad122fc565dd5c01398c31"
  version "0.1.224"
  license "MIT"
  depends_on "python"
  depends_on "aria2"
