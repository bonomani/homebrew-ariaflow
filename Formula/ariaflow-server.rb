class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.280.tar.gz"
  sha256 "4e69e08c6257899d41dde75c329fad0920ae4ca8ee636540747075237a41d27e"
  version "0.1.280"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
