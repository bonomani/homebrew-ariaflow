class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.314.tar.gz"
  sha256 "105afce431b4884c581944012907ad82c6629ed2fd59d926d02602f7f4add96d"
  version "0.1.314"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
