class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.302.tar.gz"
  sha256 "b7d7bd87c909880bb8a1282297d87c04ca641d4d9a782fe3f8a46d876e89b3f4"
  version "0.1.302"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
