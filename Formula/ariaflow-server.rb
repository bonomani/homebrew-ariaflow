class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.274.tar.gz"
  sha256 "e1014213a6b8ddb024bddba61bb1dd4ed0b46cded25b30474b7b570bde276076"
  version "0.1.274"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
