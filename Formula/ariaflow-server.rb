class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.300.tar.gz"
  sha256 "b52c5be498ea6ff4656879a99967515f1583ba7ee53e88c135be32c0e90bd94d"
  version "0.1.300"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
