class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.249.tar.gz"
  sha256 "d46fc5dfdfa4140e9c20d49146311b66196c25febd8a9fbcdcc1332d31f8eee5"
  version "0.1.249"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
