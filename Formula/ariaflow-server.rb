class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.191.tar.gz"
  sha256 "a2693775a95fba1a8beac70cd7e9e032dc1c3131d362dc15b7ff95dc4e4389a3"
  version "0.1.191"
  license "MIT"
  depends_on "python"
  depends_on "aria2"
