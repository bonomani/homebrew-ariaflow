class AriaflowServer < Formula
  ...
  url "https://github.com/bonomani/ariaflow-server/archive/refs/tags/v0.1.285.tar.gz"
  sha256 "143b04d2bed94c1ae0a80a13a27cfd795e5bdabf9aa2b9ecd949f1b565263a32"
  version "0.1.285"
  license "MIT"
  depends_on "node"
  depends_on "aria2"
