class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.395.tar.gz"
  sha256 "c2a925cc6193f10e2c9d45da85096a82c3c28e4e9aa255fd4b562fbb641dcecf"
  version "0.1.395"
  license "MIT"
  depends_on "python"
