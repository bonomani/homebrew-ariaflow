class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.564.tar.gz"
  sha256 "451e5eda990c8f67a1db9646351131343037214b7ceb56293259b98b3ff128f7"
  version "0.1.564"
  license "MIT"
  depends_on "python"
