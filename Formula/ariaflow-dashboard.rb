class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.523.tar.gz"
  sha256 "c465966425a139434e97ff20e589f53256d1c7e8d9c9e6aee9ce032362651b16"
  version "0.1.523"
  license "MIT"
  depends_on "python"
