class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.325.tar.gz"
  sha256 "db715690cb33b8e3eead36e86c268872aa162cbbdf3e2e60f9769ce5ef2b3a23"
  version "0.1.325"
  license "MIT"
  depends_on "python"
