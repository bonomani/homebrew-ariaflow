class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.344.tar.gz"
  sha256 "62a66ee1f3fba3577acc13284603a7fce31dcad4468dd8447fbdea72d12f928c"
  version "0.1.344"
  license "MIT"
  depends_on "python"
