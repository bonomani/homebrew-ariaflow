class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.594.tar.gz"
  sha256 "327b99a05fb07bc92fce5ac5c4369f351ae98fd1e9aeff877175d461e4ae5d7b"
  version "0.1.594"
  license "MIT"
  depends_on "python"
