class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.298.tar.gz"
  sha256 "927629efcce2ec4f99b6e8522f628dd7997443c9c8c17143d5a1277d2126f02d"
  version "0.1.298"
  license "MIT"
  depends_on "python"
