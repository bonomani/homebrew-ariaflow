class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.321.tar.gz"
  sha256 "fc859ff8f820d9c1e7eceb8f8a2eb817b7856919a1f398f53efbeafe63d244c7"
  version "0.1.321"
  license "MIT"
  depends_on "python"
