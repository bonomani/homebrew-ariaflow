class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.513.tar.gz"
  sha256 "c8582a8766d1cf81db8a5959c96430626dd0df2721698a7f9b0661c1b8feb320"
  version "0.1.513"
  license "MIT"
  depends_on "python"
