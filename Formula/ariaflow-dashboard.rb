class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.326.tar.gz"
  sha256 "98046362bef250237c6b6c142834cea8e3f8fcc9cbee24e878e6ca1b2c9b3e0d"
  version "0.1.326"
  license "MIT"
  depends_on "python"
