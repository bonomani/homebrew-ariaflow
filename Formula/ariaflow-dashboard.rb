class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.521.tar.gz"
  sha256 "4f740a4a4517a8e89510756caadaa302817403ebb9472f03adaadb80b78d87c5"
  version "0.1.521"
  license "MIT"
  depends_on "python"
