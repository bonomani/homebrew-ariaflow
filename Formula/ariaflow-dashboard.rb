class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.399.tar.gz"
  sha256 "fb2ec84d9b5536fbe269c41f99c7457b5c5078a3b24ebbc694f82820a61754eb"
  version "0.1.399"
  license "MIT"
  depends_on "python"
