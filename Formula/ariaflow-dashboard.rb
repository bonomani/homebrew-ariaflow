class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.377.tar.gz"
  sha256 "8d05b3e6579b539200c0eb144995a15263f1e7e260fad491a024d6d1a092136a"
  version "0.1.377"
  license "MIT"
  depends_on "python"
