class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.345.tar.gz"
  sha256 "058d69d65205b3cd810f60fc214cdefe8bbd24be756c248ad7f83c2efd650fec"
  version "0.1.345"
  license "MIT"
  depends_on "python"
