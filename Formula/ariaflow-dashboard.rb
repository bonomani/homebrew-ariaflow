class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.315.tar.gz"
  sha256 "c21b5a81c1761c2482c2cb1997a2483b50aaa99f24004c5c910a85ac972cbe63"
  version "0.1.315"
  license "MIT"
  depends_on "python"
