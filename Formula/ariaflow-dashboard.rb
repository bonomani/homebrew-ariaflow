class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.576.tar.gz"
  sha256 "57cd2a54e98a4a323476f5a069b50b0a4ca81edf9cc74fea6153574dd3f4ab89"
  version "0.1.576"
  license "MIT"
  depends_on "python"
