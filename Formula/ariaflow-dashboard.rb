class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.546.tar.gz"
  sha256 "80980edd9fd51df4f096acc9e3ceda179aa37ac163b76ee707cfceee0364600d"
  version "0.1.546"
  license "MIT"
  depends_on "python"
