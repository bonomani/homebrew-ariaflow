class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.363.tar.gz"
  sha256 "a343a5c1185d88468889bce80785e016a9a91160fdcdf3599bf7f533ecc5fc36"
  version "0.1.363"
  license "MIT"
  depends_on "python"
