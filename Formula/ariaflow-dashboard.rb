class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.574.tar.gz"
  sha256 "92b6b7e9d45e3234d5b0ebb907d601d91c8ca75c5dadb35abc0143ae71d2389c"
  version "0.1.574"
  license "MIT"
  depends_on "python"
