class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.388.tar.gz"
  sha256 "c561704327b7b2754da61792cd9c8bfb54991dffb801bcff8f33a1e5874313aa"
  version "0.1.388"
  license "MIT"
  depends_on "python"
