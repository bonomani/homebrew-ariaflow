class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.518.tar.gz"
  sha256 "f22e4dad539d973050088126036279386e3f33666c0a37aa8e5657e52f5e9509"
  version "0.1.518"
  license "MIT"
  depends_on "python"
