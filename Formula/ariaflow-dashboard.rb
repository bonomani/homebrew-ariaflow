class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.566.tar.gz"
  sha256 "4319908c21d54cc992eae6e87f157681f859011264ffdd701b7c7733414964e3"
  version "0.1.566"
  license "MIT"
  depends_on "python"
