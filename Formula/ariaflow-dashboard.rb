class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.585.tar.gz"
  sha256 "3b221b68aa66237543f84f0056d0a9bf04fee604b38fa9296db41bfb5277e17d"
  version "0.1.585"
  license "MIT"
  depends_on "python"
