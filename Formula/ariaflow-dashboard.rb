class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.308.tar.gz"
  sha256 "48f0cb63acf224a10086257c4eddd3f6f76b4e3aee2102dcdd5dab406cab4f60"
  version "0.1.308"
  license "MIT"
  depends_on "python"
