class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.489.tar.gz"
  sha256 "969a17a88734ada9017ea90134159530231966d4cfd80ca88c9a0d9021d13c69"
  version "0.1.489"
  license "MIT"
  depends_on "python"
