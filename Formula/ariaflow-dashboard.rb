class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.509.tar.gz"
  sha256 "2ec7457dc0e386c5661a78328481983c26804e4cf3b8deeb519258c6f04d38ef"
  version "0.1.509"
  license "MIT"
  depends_on "python"
