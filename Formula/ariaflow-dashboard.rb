class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.425.tar.gz"
  sha256 "9d2615f4e000f46370660d3d2d971fdf2bd43c5c29bfcd87d55302fc7797b3bd"
  version "0.1.425"
  license "MIT"
  depends_on "python"
