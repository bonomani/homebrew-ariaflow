class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.380.tar.gz"
  sha256 "f2be4097118194ce5454bacf0870e090cb97acb87a21f4bc7221ca2e301cf717"
  version "0.1.380"
  license "MIT"
  depends_on "python"
