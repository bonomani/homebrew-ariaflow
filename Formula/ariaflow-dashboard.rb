class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.445.tar.gz"
  sha256 "b777ed8271132a8306736f07ea0db559e6692012407fcd2b0b84ae40a08a236f"
  version "0.1.445"
  license "MIT"
  depends_on "python"
