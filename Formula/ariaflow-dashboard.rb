class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.482.tar.gz"
  sha256 "479973e6f1beb338ff369fae14c4c4844e44ec0cbf4f67729ec003ef462510c2"
  version "0.1.482"
  license "MIT"
  depends_on "python"
