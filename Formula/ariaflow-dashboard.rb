class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.472.tar.gz"
  sha256 "05ff69afcb4cb464370a4d5ecd3119c7c379fc83596c8ff047871391bcfed32d"
  version "0.1.472"
  license "MIT"
  depends_on "python"
