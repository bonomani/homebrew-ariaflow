class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.481.tar.gz"
  sha256 "8e068f7cd4f75a3e0d0a023d81d975b5f8fd6f99bfe24939d49a5f9034d60ea9"
  version "0.1.481"
  license "MIT"
  depends_on "python"
