class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.530.tar.gz"
  sha256 "93069a85b12951d430420e1c1777957c6de9a6cc460cbf33e4918f9388cd68a4"
  version "0.1.530"
  license "MIT"
  depends_on "python"
