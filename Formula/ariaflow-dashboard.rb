class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.485.tar.gz"
  sha256 "54a6594beccb30352722f509069fac7d846d242ee81a0a8bd924015e0f1cd4ee"
  version "0.1.485"
  license "MIT"
  depends_on "python"
