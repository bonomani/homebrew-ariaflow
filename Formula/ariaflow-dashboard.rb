class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.375.tar.gz"
  sha256 "b07deb1cd46779e26b51a24f37eec7084f5c55e131129639a0ffc69a1c85b30d"
  version "0.1.375"
  license "MIT"
  depends_on "python"
