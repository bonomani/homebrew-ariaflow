class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.463.tar.gz"
  sha256 "d9eae0e06343579d3a1e7b1e991cd3248ad7db1c73a74a2e7df6dcb601249183"
  version "0.1.463"
  license "MIT"
  depends_on "python"
