class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.469.tar.gz"
  sha256 "6ac685c33bf5377c75ece3ebdbbfe4a7bc0adb36f54a6d9710cc4740b6b6400a"
  version "0.1.469"
  license "MIT"
  depends_on "python"
