class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.353.tar.gz"
  sha256 "8cf4ba8cc491a3260bf8ce4bd038717ccb94eb31bfb4a985e44fd7b445d7cb7c"
  version "0.1.353"
  license "MIT"
  depends_on "python"
