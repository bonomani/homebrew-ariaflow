class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.408.tar.gz"
  sha256 "82551da93e1e3c2b774f82b2f1bebd1fc28a2693d6a8ca2157182f22b7ebe2bf"
  version "0.1.408"
  license "MIT"
  depends_on "python"
