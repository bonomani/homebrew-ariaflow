class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.540.tar.gz"
  sha256 "924cc5d86bd1ee88cf804d3d4b78788eb4f031caee094da4f2e18749e8e440a2"
  version "0.1.540"
  license "MIT"
  depends_on "python"
