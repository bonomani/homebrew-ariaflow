class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.312.tar.gz"
  sha256 "ecc0e90747bc95c0ccd5d4a470972a1b963579c8373c5fb27f98b1decdde35a1"
  version "0.1.312"
  license "MIT"
  depends_on "python"
