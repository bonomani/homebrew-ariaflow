class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.560.tar.gz"
  sha256 "b66a27e10d9be19ed0fe597e0cd5c7c70483e4a7407df0f45a5d0d214cf99db0"
  version "0.1.560"
  license "MIT"
  depends_on "python"
