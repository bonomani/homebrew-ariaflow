class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.393.tar.gz"
  sha256 "7557f56dfdd58fa06eb78ecc499b461d2e308687826ad4c6a9b76816f70a25b9"
  version "0.1.393"
  license "MIT"
  depends_on "python"
