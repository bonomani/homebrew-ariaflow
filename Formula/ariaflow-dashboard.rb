class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.444.tar.gz"
  sha256 "5fcc5cd380e80081adb6dd5a860314194faeed9b912040e840877f79ea54257a"
  version "0.1.444"
  license "MIT"
  depends_on "python"
