class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.550.tar.gz"
  sha256 "bad508b87b8621a958a86972d9c273b1cd968ebea0c946fbd079bf6e6066ff42"
  version "0.1.550"
  license "MIT"
  depends_on "python"
