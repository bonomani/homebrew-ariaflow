class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.577.tar.gz"
  sha256 "898255053b5a0f75f4ae302bddbac1348fb2697d84bf2448676f67560a95b139"
  version "0.1.577"
  license "MIT"
  depends_on "python"
