class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.475.tar.gz"
  sha256 "3e9a9ccd17f83142d4a6ad5abf31a7df9ff1b5f12afee51a78def3062fce445a"
  version "0.1.475"
  license "MIT"
  depends_on "python"
