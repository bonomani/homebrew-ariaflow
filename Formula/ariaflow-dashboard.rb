class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.453.tar.gz"
  sha256 "fa0ff1e5d2acde8acd9824efaf105e83384d1f18449089f42b70960549126691"
  version "0.1.453"
  license "MIT"
  depends_on "python"
