class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.583.tar.gz"
  sha256 "a7a2a61514e003dd8c183ccdd117cdc57d4c6bbcd98dedb3c07806cc9ea98d5f"
  version "0.1.583"
  license "MIT"
  depends_on "python"
