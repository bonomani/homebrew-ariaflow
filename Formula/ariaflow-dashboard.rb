class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.354.tar.gz"
  sha256 "c1ca12ebde17f132abbc7f46386ae065f0caa9f14d6bbf6c7419c193a3e33dab"
  version "0.1.354"
  license "MIT"
  depends_on "python"
