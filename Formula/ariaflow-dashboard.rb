class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.459.tar.gz"
  sha256 "5e5e5ca7c69c1b42046a9c987211ddea7a0e1c0bb7c397cad89f31490bba1397"
  version "0.1.459"
  license "MIT"
  depends_on "python"
