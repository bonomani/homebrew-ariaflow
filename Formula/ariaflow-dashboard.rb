class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.508.tar.gz"
  sha256 "a3011a8a55e0fd17107fe5f8253a2d1e43936721ecf0b312d834abd7b0ec906c"
  version "0.1.508"
  license "MIT"
  depends_on "python"
