class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.572.tar.gz"
  sha256 "9abecbf400033072a65383ed262d3f8b91720b619626645f013104279a4692b6"
  version "0.1.572"
  license "MIT"
  depends_on "python"
