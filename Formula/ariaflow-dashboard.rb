class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.368.tar.gz"
  sha256 "51aa5e1829f5362729056bc8dd605600237454d99d4b21ca0d1bc930693e774c"
  version "0.1.368"
  license "MIT"
  depends_on "python"
