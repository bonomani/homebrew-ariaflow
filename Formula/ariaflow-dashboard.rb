class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.593.tar.gz"
  sha256 "06350d0e58112f605d225da3ed21b470fe08228888b8e36d6464a9ce336b8dbe"
  version "0.1.593"
  license "MIT"
  depends_on "python"
