class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.465.tar.gz"
  sha256 "3070907f9a957cc6ebeae3a8a8042ade8ef8f2ae362a76cf4be8e6b571c4c133"
  version "0.1.465"
  license "MIT"
  depends_on "python"
