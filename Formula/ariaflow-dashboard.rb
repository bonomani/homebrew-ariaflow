class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.527.tar.gz"
  sha256 "7dc0802b6ba849fd4a974dad0b6fc3ab65634f3914201db6e32bbf4d2ba42fb7"
  version "0.1.527"
  license "MIT"
  depends_on "python"
