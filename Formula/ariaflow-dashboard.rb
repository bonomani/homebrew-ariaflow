class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.454.tar.gz"
  sha256 "58bb73700ae61b97a7c6a283b1b8ec828edc8195f312d37c852a11c5e5d9b453"
  version "0.1.454"
  license "MIT"
  depends_on "python"
