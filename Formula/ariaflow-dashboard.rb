class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.562.tar.gz"
  sha256 "bc27ad1cf9a2bcbd25d5e9dbbd5095073f3764eda17ecedcafb6ba3a25b54ec3"
  version "0.1.562"
  license "MIT"
  depends_on "python"
