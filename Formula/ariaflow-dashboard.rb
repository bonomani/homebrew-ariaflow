class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.327.tar.gz"
  sha256 "941957297d63217a3612cbbae21f6d579205badb1e7542a0800774de0e28b5a3"
  version "0.1.327"
  license "MIT"
  depends_on "python"
