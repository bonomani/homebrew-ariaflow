class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.443.tar.gz"
  sha256 "657c5696f8312136b885619791a042e8b3f48dca6cad1581320806c719c87917"
  version "0.1.443"
  license "MIT"
  depends_on "python"
