class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.362.tar.gz"
  sha256 "94e61d74c49edeed6718429b72b9980a19df7154ae9f12ff79b5f44e679112d3"
  version "0.1.362"
  license "MIT"
  depends_on "python"
