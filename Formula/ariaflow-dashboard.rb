class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.390.tar.gz"
  sha256 "2b11a062500e9b431971efb7f9f86bb510c3338cbb62a435d6b6ed88d5e2a103"
  version "0.1.390"
  license "MIT"
  depends_on "python"
