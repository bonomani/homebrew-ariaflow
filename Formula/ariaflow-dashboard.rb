class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.553.tar.gz"
  sha256 "c42275604d70a111827138c5e9a8b63f0c17d7a3b39d74ece9a273fc3bd6bb8a"
  version "0.1.553"
  license "MIT"
  depends_on "python"
