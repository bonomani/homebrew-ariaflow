class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.597.tar.gz"
  sha256 "bc6673c2b8f9cf2e8377de934f5f14669a94cd1122cba6aa9f2daa19cd12995f"
  version "0.1.597"
  license "MIT"
  depends_on "python"
