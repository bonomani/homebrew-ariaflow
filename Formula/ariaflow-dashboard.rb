class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.592.tar.gz"
  sha256 "8d8457fcd8ce342607ccf2833cbe2ab25ab5b8d0caf612afc81e20dce87e44e2"
  version "0.1.592"
  license "MIT"
  depends_on "python"
