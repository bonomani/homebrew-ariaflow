class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.460.tar.gz"
  sha256 "b4783917bdcc70a50845396bde2f8df17025fdc25c8c03a4f6964df770c89423"
  version "0.1.460"
  license "MIT"
  depends_on "python"
