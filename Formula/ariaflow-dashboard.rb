class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.493.tar.gz"
  sha256 "6f5e67d299baaf74d2f791cda36ac85a96afb2485cb8ecdbe8f0f92cfbeb8b79"
  version "0.1.493"
  license "MIT"
  depends_on "python"
