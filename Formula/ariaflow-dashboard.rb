class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.335.tar.gz"
  sha256 "20aa3591dda9172e52ada240c9cd13b0229d7d9fa393f5fdfc0c6f83cad0f0aa"
  version "0.1.335"
  license "MIT"
  depends_on "python"
