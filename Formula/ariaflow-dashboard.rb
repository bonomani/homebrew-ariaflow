class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.502.tar.gz"
  sha256 "0d2f80d7b84484343705c3b3bf25c35f170913e3c5cf97129c1e05e89cfdbba4"
  version "0.1.502"
  license "MIT"
  depends_on "python"
