class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.316.tar.gz"
  sha256 "b9ccc7f3958bcbb5330fe508006228ce06e8d5ce9901bc5fe43ef02f149bbcb1"
  version "0.1.316"
  license "MIT"
  depends_on "python"
