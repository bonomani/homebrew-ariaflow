class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.447.tar.gz"
  sha256 "b9347c00b416d268010abacf9d1f03c50e0f0ba7d9e1a6c077eb7d2af384e9b6"
  version "0.1.447"
  license "MIT"
  depends_on "python"
