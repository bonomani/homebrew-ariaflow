class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.478.tar.gz"
  sha256 "31de0ac8557ea347ce3b65e7e5052e877678365110462f7b0e819abd30895a89"
  version "0.1.478"
  license "MIT"
  depends_on "python"
