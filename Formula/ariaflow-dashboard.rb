class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.430.tar.gz"
  sha256 "3f2f48cf75b0ef37618455713fea18510ec42d60b7d1247b785e2affd1bdb23b"
  version "0.1.430"
  license "MIT"
  depends_on "python"
