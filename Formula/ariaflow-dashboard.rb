class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.575.tar.gz"
  sha256 "e1b393bb0c24440601790f58b83b3a95b74067926514fcc0e98025462ea84c7b"
  version "0.1.575"
  license "MIT"
  depends_on "python"
