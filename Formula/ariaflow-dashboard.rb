class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.371.tar.gz"
  sha256 "ada6f808b07ee6fe7e94c27c5b3176b25cd2a32b805a671afe6699f001f023ff"
  version "0.1.371"
  license "MIT"
  depends_on "python"
