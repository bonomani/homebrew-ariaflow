class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.427.tar.gz"
  sha256 "480be618577301dda0d10ea4c1d339b9c5978f648876534768951ac9a50f1ec5"
  version "0.1.427"
  license "MIT"
  depends_on "python"
