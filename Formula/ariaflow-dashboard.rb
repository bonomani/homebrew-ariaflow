class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.559.tar.gz"
  sha256 "ccf1dfa9d78eb7593867d9f632d60c6215feef55aa61e4ca44b63dda8b9f613c"
  version "0.1.559"
  license "MIT"
  depends_on "python"
