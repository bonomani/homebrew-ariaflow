class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.483.tar.gz"
  sha256 "c041636e01331b6817bc5810a9d7c68f8d419514a473f7b0e4feab052e96126f"
  version "0.1.483"
  license "MIT"
  depends_on "python"
