class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.519.tar.gz"
  sha256 "c8a6822c5d7233fe388d5c733226823d2f3981febbefceeea82b52639d067dcb"
  version "0.1.519"
  license "MIT"
  depends_on "python"
