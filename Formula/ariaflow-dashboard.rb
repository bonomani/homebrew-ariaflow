class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.413.tar.gz"
  sha256 "0c49d77cde2e7712cd31f8f531fc1910258444ec88ca3d90b48581f20765cd86"
  version "0.1.413"
  license "MIT"
  depends_on "python"
