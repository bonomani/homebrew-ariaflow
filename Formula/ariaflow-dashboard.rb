class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.532.tar.gz"
  sha256 "f049dd85993827440b1acbd3d2195a2acae50ddafeb0749506bf995ab8cb2d93"
  version "0.1.532"
  license "MIT"
  depends_on "python"
