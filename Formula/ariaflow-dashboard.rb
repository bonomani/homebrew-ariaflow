class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.295.tar.gz"
  sha256 "fafe5771728cfd37f9756746a9a32c9f4cacca6327a362c0a004e8cf0a713c60"
  version "0.1.295"
  license "MIT"
  depends_on "python"
