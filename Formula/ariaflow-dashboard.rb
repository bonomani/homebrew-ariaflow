class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.428.tar.gz"
  sha256 "7383cd49aac5de062b8dbceb17f2396cfd2e0ddfc2cf3d7af8ae8afac2cca266"
  version "0.1.428"
  license "MIT"
  depends_on "python"
