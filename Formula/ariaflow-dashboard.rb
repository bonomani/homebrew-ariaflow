class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.292.tar.gz"
  sha256 "3a40a81624864141138e7fbdbc51224b2441cb5a0a8bb0e0e18571abddbdbd3a"
  version "0.1.292"
  license "MIT"
  depends_on "python"
