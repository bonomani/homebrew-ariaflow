class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.586.tar.gz"
  sha256 "3e2169a96ebe4ac8b830ed47b33bc7f7e37a2a8b2ed030417810ab283217c6b4"
  version "0.1.586"
  license "MIT"
  depends_on "python"
