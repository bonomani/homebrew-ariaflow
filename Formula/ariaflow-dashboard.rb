class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.372.tar.gz"
  sha256 "1b76076997bb792bece3419ea5750c5d9ff5601977795a88dc5d90ef0b91db34"
  version "0.1.372"
  license "MIT"
  depends_on "python"
