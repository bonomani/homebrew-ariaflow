class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.421.tar.gz"
  sha256 "e1e95a4c9f304c7a6f68eaeeb45206ad610eb950c7d81a16b947a776ee4f8f3d"
  version "0.1.421"
  license "MIT"
  depends_on "python"
