class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.555.tar.gz"
  sha256 "d1c9a73ae5275131ce7d05e5d28d2e6f3f84c36391145bc431b1bed9e3479f4d"
  version "0.1.555"
  license "MIT"
  depends_on "python"
