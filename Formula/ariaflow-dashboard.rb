class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.476.tar.gz"
  sha256 "5cd72de1e6a17c706879cb49329ae9ca52c1ef072143dd599555f6cb3a3cecc1"
  version "0.1.476"
  license "MIT"
  depends_on "python"
