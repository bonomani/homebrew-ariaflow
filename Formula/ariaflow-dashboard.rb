class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.503.tar.gz"
  sha256 "cd303f9f35523f6b18a9a8c0b6c938eaf2f6dcdaf2799863d5739dfd7fda54bd"
  version "0.1.503"
  license "MIT"
  depends_on "python"
