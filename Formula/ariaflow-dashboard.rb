class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.423.tar.gz"
  sha256 "42952001827c7574c65dca9717b6020ba9913598a0a28e2bba5fe768b2bfcd83"
  version "0.1.423"
  license "MIT"
  depends_on "python"
