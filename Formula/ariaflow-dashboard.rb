class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.579.tar.gz"
  sha256 "0204f587ea60fd02c7e767e2f173526484b5fd97226a76469ba426fd135cc52a"
  version "0.1.579"
  license "MIT"
  depends_on "python"
