class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.290.tar.gz"
  sha256 "e40fce6a275c74b6bb3d78a29c234e3ccf7e136b4a4889e9e3993e2f7a54011a"
  version "0.1.290"
  license "MIT"
  depends_on "python"
