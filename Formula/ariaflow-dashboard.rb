class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.512.tar.gz"
  sha256 "b1d2ea741b06b2743044e8f575368e5aab0b188b63ab78e10b1f9f919150e6fb"
  version "0.1.512"
  license "MIT"
  depends_on "python"
