class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.348.tar.gz"
  sha256 "ac9df790926454bfed7e5a6115039cbff8c740f04d2fd16631ab297f79bceeb4"
  version "0.1.348"
  license "MIT"
  depends_on "python"
