class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.491.tar.gz"
  sha256 "f01b1e974b7c2250b7492f7f186360948bb1048b1216a3f936b2e2f7d67cc5bf"
  version "0.1.491"
  license "MIT"
  depends_on "python"
