class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.494.tar.gz"
  sha256 "5c6abd3a9a8f08a5226be2fc7a5d669b2a4a83323014b9b34cf41ad3dd894eae"
  version "0.1.494"
  license "MIT"
  depends_on "python"
