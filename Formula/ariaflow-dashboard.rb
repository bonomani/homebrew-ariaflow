class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.458.tar.gz"
  sha256 "0ab385ef90a88f9e0e5b7b47ab936e0bdd3313de0e54a852c1fbcbfdc81794ce"
  version "0.1.458"
  license "MIT"
  depends_on "python"
