class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.520.tar.gz"
  sha256 "53398ec92e8b47f3f2a14e44616f134269471b9e4fc9d4ab617a59c44ff446e4"
  version "0.1.520"
  license "MIT"
  depends_on "python"
