class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.471.tar.gz"
  sha256 "357b739017db63ac7d9a410608ff9ef721ffc48fcbe86d70aa869dee970afdfd"
  version "0.1.471"
  license "MIT"
  depends_on "python"
