class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.306.tar.gz"
  sha256 "c400037830fbb8bae11650b4571fd855e176bdec156d3ec770c9e5fceac9ac82"
  version "0.1.306"
  license "MIT"
  depends_on "python"
