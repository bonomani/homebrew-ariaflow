class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.451.tar.gz"
  sha256 "16edcb6022f77fd25bf570484a6e402439747efe9447537a9f5b85f05fdd3be9"
  version "0.1.451"
  license "MIT"
  depends_on "python"
