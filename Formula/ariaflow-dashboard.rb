class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.403.tar.gz"
  sha256 "d4f395e954212a2b04ef12d5ed5697d5c917271961ba10e63036392bbdbe8e03"
  version "0.1.403"
  license "MIT"
  depends_on "python"
