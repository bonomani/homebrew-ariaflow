class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.537.tar.gz"
  sha256 "69834eb8afc999053339deab8ac9ff67a9448ec36420fda37a979fbc4601d8f1"
  version "0.1.537"
  license "MIT"
  depends_on "python"
