class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.490.tar.gz"
  sha256 "55ff4ebee0cf3effc9fd21bfc001e12b78ff5c7025f9aa037b7d6266ba7396d1"
  version "0.1.490"
  license "MIT"
  depends_on "python"
