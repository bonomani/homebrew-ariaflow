class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.336.tar.gz"
  sha256 "63005f79c5a9a9bf278ffc6ed20ad5386ff448619062d22f3e75429377503275"
  version "0.1.336"
  license "MIT"
  depends_on "python"
