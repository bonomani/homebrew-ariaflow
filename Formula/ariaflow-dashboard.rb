class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.434.tar.gz"
  sha256 "27d5c1772ba2bf677516f2a080e5af36d3c0501c752ee52771835b05f1298467"
  version "0.1.434"
  license "MIT"
  depends_on "python"
