class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.466.tar.gz"
  sha256 "5012d5aca791a6362859f2d38f92c3b72ef403abfab2bbbe6d7dbcd9a1b60a64"
  version "0.1.466"
  license "MIT"
  depends_on "python"
