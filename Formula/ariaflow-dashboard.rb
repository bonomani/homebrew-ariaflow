class AriaflowDashboard < Formula
  ...
  url "https://github.com/bonomani/ariaflow-dashboard/archive/refs/tags/v0.1.514.tar.gz"
  sha256 "3fcccee0d1dff6548f90b9af7fb248e0a617894d55b9a5da6b1a69e079eb4abd"
  version "0.1.514"
  license "MIT"
  depends_on "python"
